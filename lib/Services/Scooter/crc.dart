...
class CrC {
  factory CrC() => _instance;

  CrC._internal();

  static final CrC _instance = CrC._internal();

  String calculateFrom(List<String> inputList) {
    final List<int> listToInt =
        inputList.map((e) => int.parse(e, radix: 16)).toList();
    final CrcValue crc = Crc8Maxim().convert(listToInt);
    print("crc => ${crc.toRadixString(16)}");
...
// //     crc = int.parse(_cRC8Table[crc ^ int.parse(data[i])], radix: 16);
// //   }
// //   return crc.toRadixString(16);
// // }
